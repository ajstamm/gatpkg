...
> 2015 and the first release of the R package for GAT in 2020.
...
* Developed several vignettes, including a tutorial, and expanded the 
  technical notes and troubleshooting document.
...
* Added function options to user input dialogs allow the following:
