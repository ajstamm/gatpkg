...
*Note: For users who wish to modify GAT, a developer's manual is in progress. Developer options have been written into several of the package functions. Check the functions' help pages (linked from function names) and the [Technical Notes](../doc/gat_tech_notes.html) for more information. Users interested only in running GAT can ignore these links.*
...
```{r shppic, out.width = '100%', fig.cap = 'Dialog: Identify Shapefile', echo = FALSE}
...
```{r idpic, out.width = '100%', fig.cap = 'Dialog: Identify Identifier', echo = FALSE}
...
The function [identifyGATid()](../html/identifyGATid.html) lists only character variables with unique values from the shapefile's DBF. If the identifier you are looking for does not show up, it may either be numeric or contain at least one non-unique value. If you wish to use a numeric identifer, you will need to convert it to character before running GAT.
...
```{r boundarypic, out.width = '100%', fig.cap = 'Dialog: Identify Boundary', echo = FALSE}
...
```{r agg1pic, out.width = '100%', fig.cap = 'Dialog: Identify First Aggregator', echo = FALSE}
...
```{r excludepic, fig.cap = 'Dialog: Identify Exclusion Criteria', out.width = '60%', echo = FALSE}
...
```{r excludepic2, fig.cap = 'Dialog: Confirm Exclusion Criteria', out.width = '40%', echo = FALSE}
...
```{r pb7, out.width = '55%', fig.cap = 'Progress Bar: Identify Merge Type', echo = FALSE}
...
```{r mergepic, out.width = '50%', fig.cap = 'Dialog: Identify Merge Type', out.width = '60%', echo = FALSE}
...
```{r popdialog, out.width = '100%', fig.cap = 'Dialog: Identify Population Shapefile', echo = FALSE}
...
```{r popconfirm, out.width = '100%', fig.cap = 'Dialog: Confirm Population Shapefile', echo = FALSE}
...
```{r ratepic, out.width = '50%', fig.cap = 'Dialog: Identify Rate Settings', echo = FALSE}
...
```{r kmlpic, out.width = '45%', fig.cap = 'Dialog: Save KML', echo = FALSE}
...
```{r savepic, out.width = '100%', fig.cap = 'Dialog: Save File', echo = FALSE}
...
```{r confirmpic, out.width = '60%', fig.cap = 'Dialog: Confirm GAT Settings', echo = FALSE}
