...
* Converted all uses of rgeos, rgdal, lwgeom, foreign, and sp to sf and removed those dependencies. 
...
* Added 'GATid' variable to clone selected merge variable instead of overwriting it.
* Fixed a bug that incorrectly assigned GATid for the crosswalk and messed up the final aggregated areas.
