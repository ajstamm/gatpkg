...
GAT creates several variables in both the original shapefile, which it resaves as a crosswalk, and the aggregated shapfile. These variables are listed below. For the flag variable, a brief data dictionary is provided both below and in the log produced by GAT, to help identify possible issues in the aggregation.
...
- **GATpop:** population of the aggregated area, from the population file (applies only if population weighting is selected)
